...
product=add('product','PBXFileReference',explicitFileType='wrapper.application',path='FoldNotes.app',sourceTree='BUILT_PRODUCTS_DIR')
...
target=add('target','PBXNativeTarget',name='FoldNotes',productName='FoldNotes',productType='com.apple.product-type.application',productReference=product,buildConfigurationList=configs('app',app),buildPhases=[sourcephase,frameworks,resources],buildRules=[],dependencies=[])
...
out=root/'FoldNotes.xcodeproj'; out.mkdir(exist_ok=True)
