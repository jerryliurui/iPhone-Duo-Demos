...
product=add('product','PBXFileReference',explicitFileType='wrapper.application',path='DuelClock.app',sourceTree='BUILT_PRODUCTS_DIR')
...
target=add('target','PBXNativeTarget',name='DuelClock',productName='DuelClock',productType='com.apple.product-type.application',productReference=product,buildConfigurationList=configs('app',app),buildPhases=[sourcephase,frameworks,resources],buildRules=[],dependencies=[])
...
out=root/'DuelClock.xcodeproj'; out.mkdir(exist_ok=True)
