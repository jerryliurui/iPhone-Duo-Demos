...
product=add('product','PBXFileReference',explicitFileType='wrapper.application',path='PocketPalette.app',sourceTree='BUILT_PRODUCTS_DIR')
...
target=add('target','PBXNativeTarget',name='PocketPalette',productName='PocketPalette',productType='com.apple.product-type.application',productReference=product,buildConfigurationList=configs('app',app),buildPhases=[sourcephase,frameworks,resources],buildRules=[],dependencies=[])
...
out=root/'PocketPalette.xcodeproj'; out.mkdir(exist_ok=True)
